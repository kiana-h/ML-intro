...
for person, info in data_dict.items():
    ...
    if info["exercised_stock_options"] != "NaN":
        if info["exercised_stock_options"] > max_stock:
            max_stock = info["exercised_stock_options"]
        if info["exercised_stock_options"] < min_stock:
            min_stock = info["exercised_stock_options"]
...
for person, info in data_dict.items():
    ...
    if info["salary"] != "NaN":
        if info["salary"] > max_salary:
            max_salary = info["salary"]
        if info["salary"] < min_salary:
            min_salary = info["salary"]
